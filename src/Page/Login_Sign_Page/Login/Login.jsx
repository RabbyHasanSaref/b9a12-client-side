...
const Login = () => {
    ...
    const { createLogin, createGoogleUser } = useAuth(); 
    ...
    return (
        <div className="w-full max-w-sm mx-auto overflow-hidden bg-orange-50 rounded-lg shadow-md dark:bg-gray-800 mt-10">
            ...
            <div className="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
                ...
                <Link to="/register"><p className="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline">Register</p></Link>
            </div>
        </div>
    );
};
