...
const Contact = () => {
    return (
        <section className="min-h-screen bg-orange-50 dark:bg-gray-900 mt-10 ">
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:flex lg:items-center lg:-mx-10">
                        ...
                        <form className="mt-12">
                            <div className="-mx-2 md:items-center md:flex">
                                <div className="flex-1 px-2">
                                    <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200 font-bold">Full Name</label>
                                    <input type="text" placeholder="John Doe" className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>

                                <div className="flex-1 px-2 mt-4 md:mt-0">
                                    <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200 font-bold">Email address</label>
                            ...
                            <div className="w-full mt-4">
                                <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200 font-bold">Message</label>
                    ...
                    <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                        {/* <img className="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96" src="https://i.ibb.co/YkKDNT8/IMG-20230710-134925-359.jpg" alt=""/> */}
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">01730283920</span>
                                </p>
                                ...
                                <p className="flex items-start -mx-2">
                                    ...
                                    <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">info@onlineedubd.com</span>
                                </p>
                            </div>
